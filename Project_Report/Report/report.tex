...
\vspace*{1\baselineskip}} 
Rathin Desai  \hspace{25 mm} Exam No:  \\
Shubhankar Deshpande \hspace{25 mm} Exam No:   \\
Archit Sakhadeo \hspace{25 mm} Exam No:  \\
Shadab Shaikh \hspace{25 mm} Exam No:\\
\vspace*{2\baselineskip}
...
\vspace*{1\baselineskip} 
\centerline{Rathin Desai  \hspace{25 mm} Exam No: } 
\centerline{Shubhankar Deshpande \hspace{25 mm} Exam No:  } 
\centerline{Archit Sakhadeo \hspace{25 mm} Exam No: }
\centerline{Shadab Shaikh \hspace{25 mm} Exam No: }
\vspace*{1\baselineskip} 
is a bonafide work carried out by Students under the supervision of Prof. Y.A. Handge and it
...
\begin{tabular}{c c }
Prof. Y.A. Handge &  \hspace{50 mm} Prof. R.B. Ingle \\								
...
{ \setlength{\parindent}{0mm} }
Radio interferometric image generation is a tedious task, with numerous weeks of manual effort required to be invested before the synthesis of a single image. The time complexity of manual image synthesis can be attributed to multiple factors including flagging of data, and the inherently interactive nature of existing tools used for high resolution astronomical imaging. This situation is expected to further worsen with the development of wide bandwidth upgrades for the GMRT, which will lead to increased data throughput, and hence increased processing time (assuming at least a linear relation between data hypercube sizes and time for processing). A collection of AIPS based software for source peeling and atmospheric modeling includes direction-dependent and direction-independent calibration, and has been shown to work well on a subset of data collected by the GMRT at different frequencies. Through bootstrapping specific features of this tool, and integrating with a custom high performance computing cluster that we have designed and implemented, we convert raw correlated radio interferemotric data from the GMRT, to synthesize primary beam corrected images in a massively parallel automated manner. Our primary implementation has shown to be robust, and has been tested with over 2000 Gigabytes of data, to synthesize 1000+ images reducing the processing time from 6+ weeks to a mere 10-12 hours.
{  \newpage {\bfseries \fontsize{14}{12} \selectfont \centerline{Acknowledgments} 
\vspace*{2\baselineskip}} \setlength{\parindent}{11mm} }
{ \setlength{\parindent}{0mm} }
\textit{It gives us great pleasure in presenting the preliminary project report 
on {\bfseries \fontsize{12}{12} \selectfont GMRT ARCHIVAL UTILILTY FOR DATA ANALYSIS}.}
\vspace*{1.5\baselineskip}

 \textit{I would like to take this opportunity to thank my internal guide
 \textbf{Prof. Y.A. Handge} for giving me all the help and guidance I needed. I am
...
GMRT Archival Utility for Data Analysis

\section{ Project Option }
Research Institute Sponsored

\section{Internal Guide}
Prof. Y.A. Handge

\section{ Sponsorship and External Guide} 
National Center for Radio Astrophysics, Tata Institute of Fundamental Research (NCRA-TIFR)\\
Dr.Yogesh Wadadekar \& Dr.C.H. Ishwara Chandra
